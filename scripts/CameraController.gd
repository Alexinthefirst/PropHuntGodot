...
func _ready():
	set_process(get_parent().get_multiplayer_authority() == multiplayer.get_unique_id())
	set_process_input(get_parent().get_multiplayer_authority() == multiplayer.get_unique_id())
